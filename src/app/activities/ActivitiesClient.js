  ...
  return (
    <div className="activities-page">
          ...
          <section className="page-header">
            ...
            <div className="container hero-content">
              ...
              <h1 className="header-title reveal active">
                {getDynamicContent('activities_hero_title1', 'activities.hero.title1')} <br/> <em>{getDynamicContent('activities_hero_title2', 'activities.hero.title2')}</em>
              </h1>
      ...
      <style jsx>{`
        ...
        .activity-image-container { padding: 16px 16px 0 16px; position: relative; z-index: 2; }
        .activity-image { width: 100%; height: 220px; border-radius: 14px; overflow: hidden; position: relative; box-shadow: 0 4px 15px rgba(0,0,0,0.05); background: #f0f4f2; }
        .activity-image img { width: 100%; height: 100%; object-fit: cover; transition: transform 0.6s cubic-bezier(0.165, 0.84, 0.44, 1); }
        ...
        .activity-date-badge { position: absolute; top: 12px; right: 12px; background: rgba(255,255,255,0.95); backdrop-filter: blur(4px); color: var(--green-deep); padding: 6px 12px; border-radius: 30px; font-size: 0.75rem; font-weight: 700; box-shadow: 0 4px 10px rgba(0,0,0,0.1); display: flex; align-items: center; gap: 6px; z-index: 3; }
