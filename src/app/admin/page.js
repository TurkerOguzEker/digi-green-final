        ...
        <div style={{background:'#fcfcfc', padding:'40px', borderRadius:'12px', border:'1px solid #eee', boxShadow:'0 5px 20px rgba(0,0,0,0.03)'}}>
            ...
            {activeTab === 'home' && (
                <div className="fade-in">
                    ...
                    <SettingInput label="Hero Arka Plan (En Üst Resim)" settingKey="hero_bg_image" type="image" />
                    ...
                    <SettingInput label="Kart 1 Değer (Örn: 24 Ay)" settingKey="home_summary_1_val" />
                    <SettingInput label="Kart 1 Etiket (Örn: Proje Süresi)" settingKey="home_summary_1_label" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Kart 2 Değer" settingKey="home_summary_2_val" />
                    <SettingInput label="Kart 2 Etiket" settingKey="home_summary_2_label" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Kart 3 Değer" settingKey="home_summary_3_val" />
                    <SettingInput label="Kart 3 Etiket" settingKey="home_summary_3_label" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Kart 4 Değer" settingKey="home_summary_4_val" />
                    <SettingInput label="Kart 4 Etiket" settingKey="home_summary_4_label" />

                    <h4 style={{margin:'40px 0 20px', color:'#555', borderLeft:'4px solid #003399', paddingLeft:'10px'}}>3. Hakkında Bölümü</h4>
                    <SettingInput label="Bölüm Görseli (Sol Taraf)" settingKey="home_about_image" type="image" />
                    <SettingInput label="Başlık" settingKey="home_about_title" />
                    <SettingInput label="Metin" settingKey="home_about_text" type="textarea" />

                    <h4 style={{margin:'40px 0 20px', color:'#555', borderLeft:'4px solid #003399', paddingLeft:'10px'}}>4. Hedef Kitle Kartları</h4>
                    <SettingInput label="Kart 1 Başlık (Örn: Vatandaşlar)" settingKey="home_target_1_title" />
                    <SettingInput label="Kart 1 Açıklama" settingKey="home_target_1_desc" type="textarea" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Kart 2 Başlık (Örn: Yerel Yönetimler)" settingKey="home_target_2_title" />
                    <SettingInput label="Kart 2 Açıklama" settingKey="home_target_2_desc" type="textarea" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Kart 3 Başlık (Örn: Çevre)" settingKey="home_target_3_title" />
                    <SettingInput label="Kart 3 Açıklama" settingKey="home_target_3_desc" type="textarea" />

                    <h4 style={{margin:'40px 0 20px', color:'#555', borderLeft:'4px solid #003399', paddingLeft:'10px'}}>5. Dijital Ekosistem (Ağaç Yapısı)</h4>
                    <SettingInput label="Dal 1 Başlık" settingKey="home_eco_1_title" />
                    <SettingInput label="Dal 1 Açıklama" settingKey="home_eco_1_desc" type="textarea" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Dal 2 Başlık" settingKey="home_eco_2_title" />
                    <SettingInput label="Dal 2 Açıklama" settingKey="home_eco_2_desc" type="textarea" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Dal 3 Başlık" settingKey="home_eco_3_title" />
                    <SettingInput label="Dal 3 Açıklama" settingKey="home_eco_3_desc" type="textarea" />
                    <hr style={{margin:'15px 0', borderTop:'1px dashed #ddd'}}/>
                    <SettingInput label="Dal 4 Başlık" settingKey="home_eco_4_title" />
                    <SettingInput label="Dal 4 Açıklama" settingKey="home_eco_4_desc" type="textarea" />

                    <h4 style={{margin:'40px 0 20px', color:'#555', borderLeft:'4px solid #003399', paddingLeft:'10px'}}>6. Etki Sayaçları</h4>
                    <SettingInput label="Sayaç 1 Değer (Örn: 2000)" settingKey="home_counter_1_val" />
                    <SettingInput label="Sayaç 1 Etiket" settingKey="home_counter_1_label" />
                    <SettingInput label="Sayaç 2 Değer" settingKey="home_counter_2_val" />
                    <SettingInput label="Sayaç 2 Etiket" settingKey="home_counter_2_label" />
                    <SettingInput label="Sayaç 3 Değer" settingKey="home_counter_3_val" />
                    <SettingInput label="Sayaç 3 Etiket" settingKey="home_counter_3_label" />
                    <SettingInput label="Sayaç 4 Değer" settingKey="home_counter_4_val" />
                    <SettingInput label="Sayaç 4 Etiket" settingKey="home_counter_4_label" />

                    <h4 style={{margin:'40px 0 20px', color:'#555', borderLeft:'4px solid #003399', paddingLeft:'10px'}}>7. En Alt Kapanış (CTA)</h4>
                    <SettingInput label="Kapanış Başlığı" settingKey="home_cta_title" />
                    <SettingInput label="Kapanış Metni" settingKey="home_cta_text" type="textarea" />
                </div>
            )}

            {/* Diğer Sekmeler (Partner, News, Results, Contact) AYNI KALIYOR */}
            {/* Mevcut kodlarınız burada devam etmeli... */}
