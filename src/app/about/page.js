  ...
  if (loading) {
    return (
      <div className="loading-screen" style={{ background: 'transparent', position: 'fixed', inset: 0, zIndex: 9999, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '20px' }}>
        ...
        <span style={{ fontFamily: "'Inter', sans-serif", fontSize: "0.9rem", fontWeight: "600", color: "var(--text-soft)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
          {t('about.loading') !== 'about.loading' ? t('about.loading') : 'Yükleniyor...'}
        </span>
      </div>
    );
  }
  ...
  return (
    <div className="about-page">
      ...
      <style jsx>{`
        ...
        .spinner { width: 40px; height: 40px; border: 3px solid rgba(16, 185, 129, 0.2); border-top-color: #10b981; border-radius: 50%; animation: spin 1s linear infinite; }
